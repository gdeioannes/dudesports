...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <body>
        ...
        <div id="flashContent">
       	...
       	<noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="700" height="650" id="DudeSportsGame">
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="DudeSportsGame.swf" width="700" height="650">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
